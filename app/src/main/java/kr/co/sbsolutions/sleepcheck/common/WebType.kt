...
enum class WebType( val titleKo: String,val titleEn: String, val url: String) {
    ...
    TERMS2("사용 설명서", "User Guide","https://sb-solutions.co.kr/manual/app_manual_medi.html"),
    TERMS2EN("사용 설명서", "User Guide","https://sb-solutions.co.kr/manual/app_manual_medi.html"),
}
