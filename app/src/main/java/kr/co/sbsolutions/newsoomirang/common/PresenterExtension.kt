...
fun Context.showAlertDialogWithCancel(title: Int? = null, message: String, cancelButtonText: Int = R.string.app_cancel, cancelAction: (() -> Unit)? = null, confirmButtonText: Int = R.string.app_confirm, confirmAction: (() -> Unit), cancelable: Boolean = true) {
